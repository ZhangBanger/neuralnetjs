...
// backward pass
s.grad = 1.0
sg0.backward() // write grad into axpbypc
addg1.backward() //write grad into axpby and c
addg0.backward() //write grad into ax and by
mulg1.backward() //write grad into b and y
mulg0.backward() //write grad into a and x

console.log(sg0, addg1, addg0, mulg1, mulg0)
...
console.log("gradients", a.grad, b.grad, c.grad, x.grad, y.grad)
...
console.log("numerical grads", a_grad, b_grad, c_grad, x_grad, y_grad)
